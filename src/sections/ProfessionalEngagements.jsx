                                        ...
                                        >
                                            ...
                                            {isClickable && (
                                                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors z-20 flex items-center justify-center">
                                                    <div className="opacity-0 group-hover:opacity-100 bg-white dark:bg-secondary/80 backdrop-blur-md border-t border-white/5 text-primary rounded-full p-3 shadow-xl transition-all duration-300 transform scale-50 group-hover:scale-100 absolute bottom-4 right-4">
